...
PRODUCT_COPY_FILES += \
    $(DEVICEDEVICE_PATH)/rootdir/etc/init.qcom.bt.sh:system/etc/init.qcom.bt.sh
...
# FM configurations
PRODUCT_COPY_FILES += \
    $(DEVICE_PATH)/rootdir/etc/init.qcom.fm.sh:system/etc/init.qcom.fm.sh
...
PRODUCT_COPY_FILES += \
    $(DEVICE_PATH)/rootdir/etc/init.qcom.baseband.sh:system/etc/init.qcom.baseband.sh \
...
# Logo (Needs to be merged in the Lumia 720 device tree)
...
PRODUCT_COPY_FILES += \
    $(DEVICE_PATH)/logo/initlogo.rle:root/initlogo.rle
...
# Keys layouts
PRODUCT_COPY_FILES += \
    $(DEVICE_PATH)/configs/cyttsp-i2c.kl:system/usr/keylayout/cyttsp-i2c.kl \
    $(DEVICE_PATH)/configs/gpio-keys.kl:system/usr/keylayout/gpio-keys.kl \
    $(DEVICE_PATH)/configs/keypad_8960.kl:system/usr/keylayout/keypad_8960.kl \
    $(DEVICE_PATH)/configs/msm8930-sitar-snd-card_Button_Jack.kl:system/usr/keylayout/msm8930-sitar-snd-card_Button_Jack.kl \
    $(DEVICE_PATH)/configs/pmic8xxx_pwrkey.kcm:system/usr/keychars/pmic8xxx_pwrkey.kcm \
    $(DEVICE_PATH)/configs/pmic8xxx_pwrkey.kl:system/usr/keylayout/pmic8xxx_pwrkey.kl
...
PRODUCT_COPY_FILES += \
    ...
    $(DEVICE_PATH)/rootdir/fstab.qcom:recovery/root/fstab.qcom \
...
PRODUCT_COPY_FILES += \
    $(DEVICE_PATH)/configs/thermald-8930.conf:system/etc/thermald-8930.conf
